 ...
 */
final class Version20220118044931 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE solicitud (id INT AUTO_INCREMENT NOT NULL, empresa_id INT NOT NULL, cuenta_id INT NOT NULL, usuario_id INT NOT NULL, fecha_creacion DATETIME NOT NULL, INDEX IDX_96D27CC0521E1991 (empresa_id), INDEX IDX_96D27CC09AEFF118 (cuenta_id), INDEX IDX_96D27CC0DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE solicitud_pedido (id INT AUTO_INCREMENT NOT NULL, solicitud_id INT NOT NULL, pedido_id INT NOT NULL, kilos NUMERIC(10, 3) DEFAULT NULL, latas NUMERIC(10, 3) DEFAULT NULL, INDEX IDX_E63C313D1CB9D6E4 (solicitud_id), INDEX IDX_E63C313D4854653A (pedido_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE solicitud_receta (id INT AUTO_INCREMENT NOT NULL, receta_id INT NOT NULL, solicitud_id INT NOT NULL, INDEX IDX_92436EBD54F853F8 (receta_id), INDEX IDX_92436EBD1CB9D6E4 (solicitud_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE solicitud_receta_detalle (id INT AUTO_INCREMENT NOT NULL, solicitud_receta_id INT NOT NULL, receta_detalle_id INT NOT NULL, INDEX IDX_40016531BF6CFEE2 (solicitud_receta_id), INDEX IDX_400165313E91D875 (receta_detalle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE solicitud ADD CONSTRAINT FK_96D27CC0521E1991 FOREIGN KEY (empresa_id) REFERENCES empresa (id)');
        $this->addSql('ALTER TABLE solicitud ADD CONSTRAINT FK_96D27CC09AEFF118 FOREIGN KEY (cuenta_id) REFERENCES cuenta (id)');
        $this->addSql('ALTER TABLE solicitud ADD CONSTRAINT FK_96D27CC0DB38439E FOREIGN KEY (usuario_id) REFERENCES usuario (id)');
        $this->addSql('ALTER TABLE solicitud_pedido ADD CONSTRAINT FK_E63C313D1CB9D6E4 FOREIGN KEY (solicitud_id) REFERENCES solicitud (id)');
        $this->addSql('ALTER TABLE solicitud_pedido ADD CONSTRAINT FK_E63C313D4854653A FOREIGN KEY (pedido_id) REFERENCES pedido (id)');
        $this->addSql('ALTER TABLE solicitud_receta ADD CONSTRAINT FK_92436EBD54F853F8 FOREIGN KEY (receta_id) REFERENCES receta (id)');
        $this->addSql('ALTER TABLE solicitud_receta ADD CONSTRAINT FK_92436EBD1CB9D6E4 FOREIGN KEY (solicitud_id) REFERENCES solicitud (id)');
        $this->addSql('ALTER TABLE solicitud_receta_detalle ADD CONSTRAINT FK_40016531BF6CFEE2 FOREIGN KEY (solicitud_receta_id) REFERENCES solicitud_receta (id)');
        $this->addSql('ALTER TABLE solicitud_receta_detalle ADD CONSTRAINT FK_400165313E91D875 FOREIGN KEY (receta_detalle_id) REFERENCES receta_detalle (id)');
        ...
        $this->addSql('ALTER TABLE folio CHANGE empresa_id empresa_id INT DEFAULT NULL, CHANGE pedido pedido INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE solicitud_pedido DROP FOREIGN KEY FK_E63C313D1CB9D6E4');
        $this->addSql('ALTER TABLE solicitud_receta DROP FOREIGN KEY FK_92436EBD1CB9D6E4');
        $this->addSql('ALTER TABLE solicitud_receta_detalle DROP FOREIGN KEY FK_40016531BF6CFEE2');
        $this->addSql('DROP TABLE solicitud');
        $this->addSql('DROP TABLE solicitud_pedido');
        $this->addSql('DROP TABLE solicitud_receta');
        $this->addSql('DROP TABLE solicitud_receta_detalle');
        $this->addSql('ALTER TABLE accion CHANGE empresa_id empresa_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE almacen CHANGE orden orden INT DEFAULT NULL');
