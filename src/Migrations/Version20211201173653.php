 ...
 */
final class Version20211201173653 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cliente ADD telefono VARCHAR(100) DEFAULT NULL, ADD correo VARCHAR(255) DEFAULT NULL, ADD celular VARCHAR(100) DEFAULT NULL, CHANGE rut rut VARCHAR(12) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE accion CHANGE empresa_id empresa_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE cliente DROP telefono, DROP correo, DROP celular, CHANGE rut rut VARCHAR(12) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
