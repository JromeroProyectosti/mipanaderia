 ...
 */
class ClienteProveedorRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return ClienteProveedor[] Returns an array of ClienteProveedor objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?ClienteProveedor
    {
        return $this->createQueryBuilder('c')
            ->andWhere('c.exampleField = :val')
            ->setParameter('val', $value)
